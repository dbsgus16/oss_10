...
* 응용생물학전공/2020116595/이수연(knulsy20)
...
##### 판매 주문 관리 
농장을 포함한 모든 기업은 판매 주문관리가 핵심입니다. 판매 주문관리 프로세스를 통해 농장은 각 판매 주문에 대한 작물이나 서비스, 수량 및 합의된 가격을 자세히 기재하여 주문을 생성할 수 있습니다. 생성된 판매 주문은 재고 확인이 시작되고 주문 이행 프로세스가 진행됩니다. 또한 이 기능은 생성부터 배송까지 각 주문의 상태를 추적하고 시기적절하고 정확한 배송을 보장하는 데 도움이 되는 실시간 업데이트를 제공할 수 있습니다. 


![품목 가격](https://github.com/dbsgus16/oss_10/assets/166291632/66b30d51-5394-4002-98e5-c4c30d481a1c)


![납품](https://github.com/dbsgus16/oss_10/assets/166291632/e800a570-234f-4cdf-b1de-8535de72c21d)

##### 재고관리
재고관리 EPNeRxt모듈에서 농장내 품목과 재배 주기에 대한 전체적인 개요를 확인할 수 있습니다. 판매, 구매, 재고 관리와 같은 모듈을 제공하며, 어느 기업에나 필요한 전자세금 계산서 발행, 자동 결제 정산 기능 등을 포함합니다. 이러한 기능들은 견적, 주문, 배송, 청구서 발행, 결제 등의 작업을 순차적으로 처리할 수 있게 해줍니다. 또한, Excel 배치 업로드를 통한 재고 조정 등록이 가능하며, 사용자는 Excel 데이터 등록 매뉴얼을 참조해야 합니다.

![창고재고](https://github.com/dbsgus16/oss_10/assets/166291632/87019328-5c86-4e8a-bea0-c144391f201e)


프로젝트 생성: ERPNext에서 프로젝트를 생성하려면, 먼저 프로젝트 대시보드로 이동해야 합니다. 여기서 새 프로젝트를 생성하고, 프로젝트의 이름, 시작 및 종료 날짜, 관련 고객 등의 기본 정보를 입력할 수 있습니다. 

작업 할당 및 관리: 프로젝트 내에서 작업을 생성하고, 각 작업에 대한 세부 사항을 정의할 수 있습니다. 작업에는 시작 및 종료 날짜, 우선 순위, 담당자 등을 지정할 수 있으며, 작업의 진행 상황을 추적할 수 있습니다.

##### 작업 일정 관리
농업 작업을 일정에 따라 계획하고 추적할 수 있습니다. 이를 통해 농장 내 작업의 효율성을 향상시키고 생산성을 높일 수 있습니다.


프로젝트 생성:  프로젝트 대시보드로 이동해야 합니다. 여기서 새 프로젝트를 생성하고, 작업일정의 이름, 시작 및 종료 날짜, 관련 고객 등의 기본 정보를 입력할 수 있습니다. 
작업 할당 및 관리: 프로젝트 내에서 작업을 생성하고, 각 작업에 대한 세부 사항을 정의할 수 있습니다. 작업에는 시작 및 종료 날짜, 우선 순위, 담당자 등을 지정할 수 있으며, 작업의 진행 상황을 추적할 수 있습니다.


![작업과ㄴ](https://github.com/dbsgus16/oss_10/assets/166291632/f284cd52-41f4-4081-83db-04cade41ac08)


###### 농장분석 및 성과 평가
생산성 분석
작물의 생산성 및 수확량에 대한 데이터를 분석하여 농장의 성과를 평가할 수 있습니다. 이를 통해 가장 효율적으로 재배되는 작물을 식별하고 생산성을 향상시키기 위한 조치를 취할 수 있습니다.


비용 및 수익 분석
농장 운영과 생산에 따른 비용과 수익을 추적하고 분석할 수 있습니다. 이를 통해 농장의 수익성을 평가하고 비용을 최소화하는 방안을 모색할 수 있습니다.


   
#### 2)Diseases & Fertilizers Management / 이수연
...
#### 6) Sales/Purchase 공급업체 동향 분석, 가격 / 손승민
...
#### 7) Billing/Pricing 청구서, 가격 책정 / 손승민
...
#### 10) Location Management 위치 관리 / 홍예준
